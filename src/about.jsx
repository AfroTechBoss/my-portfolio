...
/* ---------------- CONTACT / FINALE ---------------- */
/* Telegram has no typographic mark like "in" or the X glyph, so the plane
   is drawn inline, sized to the row's 12px mono and inheriting its colour. */
const TgMark = () => (
...
{ h: <TgMark />, l: "Telegram", u: "afrotechboss",      url: "https://t.me/afrotechboss" },
